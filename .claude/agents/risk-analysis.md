...
7. **`Perfil Inversionista/Dayra Sostre.md`** — eres el ÚNICO especialista que lee el perfil: evalúa tanto el riesgo de poseer esta empresa como el fit con el perfil de la inversionista (capital $1,000, máx 30–60% por posición, estilo moderado a agresivo con horizonte 1–3 años y retiro parcial previsto en ese plazo, tolerancia a pérdida 5–10%, solo EE.UU., sin forex)
